          ...
          <div className="hidden md:flex items-center gap-3">
            {user ? (
              ...
              <div className="flex items-center gap-2">
                <Link
                  href="/login"
                  className="flex items-center gap-1.5 px-4 py-2 text-xs font-bold rounded-xl bg-[#B62A35] hover:bg-[#9E1F2A] text-white transition-all shadow-xs"
                >
            ...
            {user ? (
              ...
              <div className="space-y-2">
                <Link
                  href="/login"
                  onClick={() => setMobileMenuOpen(false)}
                  className="flex items-center justify-center gap-2 w-full py-2.5 text-center text-xs font-bold bg-[#B62A35] text-white rounded-xl shadow-xs"
                >
